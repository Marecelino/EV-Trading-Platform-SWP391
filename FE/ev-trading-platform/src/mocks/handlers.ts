...
const mockProducts: Product[] = [
  ...
  },
  {
    ...
    location: { city: 'Hà Nội', district: 'Hoàn Kiếm' },
     images: [
    'https://energy.panasonic.com/na/business/products/lithium-ion'  // ảnh sản phẩm pin module / pack từ trang Panasonic :contentReference[oaicite:6]{index=6}
  ],
    is_verified: false,
    is_featured: false,
    views: 430,
...
export const handlers = [
  ...
  http.post('http://localhost:5000/api/auth/login', async ({ request }) => {
    ...
    // Case 1: Đăng nhập với vai trò ADMIN
