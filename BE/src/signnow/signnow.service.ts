...
export class SignnowService {
  ...
  constructor(
    ...
    this.clientId = this.requireConfig('SIGNNOW_CLIENT_ID');
    this.clientSecret = this.requireConfig('SIGNNOW_CLIENT_SECRET');
    this.username = this.requireConfig('SIGNNOW_USERNAME');
    this.password = this.requireConfig('SIGNNOW_PASSWORD');
    this.fromEmail =
